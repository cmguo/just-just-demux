...
FRAMEWORK_LOGGER_DECLARE_MODULE_LEVEL("BufferDemuxerStatistic", 0);
...
namespace ppbox
{
    namespace demux
    {
        ...
        BufferDemuxerStatistic::BufferDemuxerStatistic()
            : state_(stopped)
            , buffer_time_(0)
        ...
        void BufferDemuxerStatistic::buf_time(
        ...
        void BufferDemuxerStatistic::change_status(
        ...
        void BufferDemuxerStatistic::open_beg()
        {
            assert(state_ == stopped);
            change_status(opening);
        }

        void BufferDemuxerStatistic::open_end()
        {
        ...
        void BufferDemuxerStatistic::pause()
        {
            if (state_ == paused)
                return;
        ...
        void BufferDemuxerStatistic::resume()
        {
            if (state_ != paused)
                return;
        ...
        void BufferDemuxerStatistic::play_on(
        ...
        void BufferDemuxerStatistic::block_on()
        {
            if (state_ == buffering)
                return;
        ...
        void BufferDemuxerStatistic::seek(
            bool ok, 
        ...
        void BufferDemuxerStatistic::on_error(
            boost::system::error_code const & ec)
        {
            last_error_ = ec;
        }

        void BufferDemuxerStatistic::close()
        {
